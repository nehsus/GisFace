...
/**
 * Created by sushen.kumaron 9/21/2017.
 */

public class LocationService_service_19 extends Service implements
        GoogleApiClient.OnConnectionFailedListener,
        GoogleApiClient.ConnectionCallbacks,
        LocationListener {
    private static final String TAG = LocationService_service_19.class.getSimpleName();
...
//
//            int[] distanceSplit = getKMinArray(round(((getUpdateDistance() / 1000) / 1000), 4));
//            points = getPoints(distanceSplit[0], distanceSplit[1]);
//            camera_fragment_19.points.setText("Points: " + points);
//
//            if (mCurrentLocation.hasSpeed()) {
//                camera_fragment_19.speed.setText("" + new DecimalFormat("#.##").format(mCurrentLocation.getSpeed()) + " km/hr");
//            } else {
//                camera_fragment_19.speed.setText("0 km/hr");
//            }
