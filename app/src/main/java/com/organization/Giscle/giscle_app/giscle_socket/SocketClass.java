package com.organization.Giscle.giscle_app.giscle_socket;
...
public class SocketClass implements Runnable{
        ...
        private com.organization.Giscle.giscle_app.User_Fragment.Camera_frag.camera_fragment mMainActivity;

        public SocketClass(com.organization.Giscle.giscle_app.User_Fragment.Camera_frag.camera_fragment act) {
            mMainActivity = act;
            mSendable = false;
        }
...
//		}
        ...
        public void run() {
            ...
            try {
                mServer = new ServerSocket(PORT);   //PORT
