...
public class RoundCornonrLayout extends FrameLayout {
    ...
    public RoundCornonrLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public RoundCornonrLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public RoundCornonrLayout(Context context, AttributeSet attrs, int defStyle) {
